  ...
  if(dini){ //billy kan true, yauda yg di eksekusi yg ini
      console.log("oke, namamu Billy")
  }else { //dan jika di kondisi bukan masukin billy, tapi bukanBilly, maka yg dieksekusi yg ini
      console.log("namamu dini")
  }
  ...
  if(b === "Bola"){
      english = "Ball";
  }else if(t === "Tidur"){ //yg di eksekusi yg ini, soalnya t itu nilainya Tidur
      english = "Sleep";
  }else if(m === "Mobil"){
      english = "car";
  }
